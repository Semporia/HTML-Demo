...
var Sortable = function() {
    function d() {
        ...
        _classCallCheck(this, d), this.parent = e, this.links = Array.from(i), this.active = a, this.margin = o,
            this.responsive = u, this.fadeDuration = h, this.elements = Array.from(this.parent.children), this.activeElements =
            this.elements, this.columns = 1, this.dataLink = "all", this.winWidth = window.innerWidth, this.init()
    }
    return _createClass(d, [{
        ...
        value: function() {
            var r = this,
                ...
                n = e.reduce(function(t, e, n) {
                    ...
                    return e.style.transform = "translate3d(" + s + "px, " + a + "px, 0)", t.push(
                        e.offsetHeight), t
                }, []),
        ...
        value: function() {
            ...
            e.forEach(function(e, t) {
                0 === t && (e.classList.add(i), n.dataLink = e.dataset.sjslink), e.addEventListener(
                    "click",
                    function(t) {
        ...
        value: function(t) {
            ...
            this.activeElements = n.filter(function(t) {
                return "all" === i ? (e._fadeIn(t, s.in), !0) : t.dataset.sjsel !== i ? (e._fadeOut(
                    t, s.out), !1) : (e._fadeIn(t, s.in), !0)
            }), t && t()
        }
    }, {
        key: "_sumArrHeight",
        ...
        value: function(e) {
            ...
            e.style.display = "block", requestAnimationFrame(function t() {
                (i += s) <= 1 ? (e.style.opacity = i, requestAnimationFrame(t)) : (e.style.opacity =
                    1, n && n())
            })
        }
    }, {
        ...
        value: function(e) {
            ...
            requestAnimationFrame(function t() {
                0 <= (i -= s) ? (e.style.opacity = i, requestAnimationFrame(t)) : (e.style.opacity =
                    0, e.style.display = "none", n && n())
            })
        }
    }]), d
}();
